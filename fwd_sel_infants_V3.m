...
%load('C:\Users\user\Documents\MATLAB\Neuro Tec\EEG Data\EEG\john-08-19-2013.mat');
...
%cd('C:\Users\user\Documents\MATLAB\Neuro Tec')
cd(LFDAGMMData_dir)
...
progress_percentage = counter/497*100; counter = counter + 1;
disp(['Progress: ', num2str(progress_percentage)])
...
ic=ClassLblXsubj;
    ...
    trainprct=tr_perc;
        ...
        classmatrixlist=[];
            ...
            parfor (iteration = 1:maxiterations,10)   %length(XvalidList(:,1));
...
%% Displaying
progress_percentage = counter/497*100;
disp(['Progress: ', num2str(progress_percentage)])
