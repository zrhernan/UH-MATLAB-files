function classstartstoptimes = importTaskTrialInfo(filename, startRow, endRow)
...
classstartstoptimes.Task = rawCellColumns(:, 1);
classstartstoptimes.StartTime = cell2mat(rawNumericColumns(:, 1));
classstartstoptimes.StopTime = cell2mat(rawNumericColumns(:, 2));
classstartstoptimes.TaskLabel = cell2mat(rawNumericColumns(:, 3));
